...
import { TitleBar, FilterPanel, WidgetWrapper, Select, useUpdateWidgetProps, RadialGauge, Checkbox, useMessageBus, DataGrid, ItemCard } from "uxp/components";
import './styles.scss';
...
const EnergyBudgetWidget: React.FunctionComponent<IWidgetProps> = (props) => {
  ...
  return (
    <WidgetWrapper>
      ...
      <div style={{ flex: 1,padding:'30px' ,marginBottom:'45px'}}>
