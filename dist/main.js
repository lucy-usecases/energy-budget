...
>>>>>>> 77ef8a4af3e44e2676568f9dd325bfc213330bc4
// Exports
module.exports = exports;
...
const Configuration = (props) => {
    ...
    const [setup, setSetup] = react_1.default.useState(false);
    ...
    react_1.default.useEffect(() => {
        ...
        (0, config_util_1.completeInstallation)(props.uxpContext);
        getModelKey();
        getCategories();
    }, []);
    ...
    const newCategory = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            yield (0, config_util_1.completeInstallation)(props.uxpContext);
            yield getCategories();
    ...
    return (react_1.default.createElement("div", { className: 'config' },
        react_1.default.createElement("div", { className: 'header' },
            ...
            react_1.default.createElement("div", { className: 'actions' },
                ...
                react_1.default.createElement(components_1.Button, { className: setup ? 'active primary' : 'primary', title: 'Setup Budgets and Categories', onClick: () => { setSetup(true); } }))),
        setup ?
