...
APIKEY="$2"
URL="$1"
curl -X POST $URL/Lucy/EnergyBudget/budget/building1/electrical  -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "budget": [100,150,200,150,150,150,200,200,200,200,200,200] }'
curl -X POST $URL/Lucy/EnergyBudget/budget/building1/mechanical  -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "budget": [50,50,50,50,50,50,50,50,50,50,50,50] }'
...
curl -X POST $URL/Lucy/EnergyBudget/consumption/building1/electrical/2021/5 -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "value": 200 }'
curl -X POST $URL/Lucy/EnergyBudget/consumption/building1/electrical/2021/6 -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "value": 20 }'
...
curl -X POST $URL/Lucy/EnergyBudget/consumption/building1/mechanical/2021/5 -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "value": 30}'
curl -X POST $URL/Lucy/EnergyBudget/consumption/building1/mechanical/2021/6 -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json" --data '{ "value": 5}'
